# Simulation code for manuscript "Adjusting Measurement Noninvariance With
# Alignment Optimization in Growth Modeling"
...
align_lambda_nu <- function(config_pars, ...) {
  ...
  aligned_pars <- sirt::invariance.alignment(config_lambda, config_nu,
                                             ...)
  aligned_pars[c("lambda.aligned", "nu.aligned")]
}
